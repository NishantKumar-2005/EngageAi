...
import { PanelLeftCloseIcon, PanelLeftIcon, SearchCheckIcon } from "lucide-react";
    ...
    return(
        ...
        <nav className="flex px-4 gap-x-2 items-center py-3 border-b bg-background">
            ...
            >
             ...
             rounded border bg-muted px-1.5 font-moto text-[10px] font-medium text-muted-foreground">
