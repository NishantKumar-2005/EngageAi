  ...
  export const MeetingIdViewHeader = ({ meetingId, meetingName, onEdit, onRemove }: Props) => {
    return (
        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbLink className="font-medium text-xl text-foreground" asChild>
       ...
       {/* Without modal={false}, the dialog that this dropdown opens cause the website to be unclickble*/}
